...
public class PurchaseRestController {
    ...
    @ApiOperation(value = "Get page of Purchases", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiOperation(value = "Buy Item in Visit", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiOperation(value = "Return Item in Visit", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiOperation(value = "Update purchase's Price", produces = MediaType.APPLICATION_JSON_VALUE)
