 ...
 */
@Api(value = "Item", description = "Item management endpoint")
@RestController
...
public class ItemRestController {
    ...
    @ApiOperation(value = "Get Item by Name", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ApiOperation(value = "Create Item", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @RequestMapping(value = "/", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public Item createItem(@RequestBody ItemForm form) {
        return this.itemService.createItem(form);
    }

    @ApiOperation(value = "Update Item", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    ...
    @ApiOperation(value = "Delete Item", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
